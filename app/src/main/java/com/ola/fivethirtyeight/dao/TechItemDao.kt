...
interface TechItemDao: BaseFeedDao<TechItemEntity> {
    ...
    //override fun getFeedsBySource(link: String): Flow<TechItemEntity?>

    @Query("SELECT * FROM tech_items WHERE link = :link LIMIT 1")
    override fun getItemByLink(link: String): Flow<TechItemEntity?>
