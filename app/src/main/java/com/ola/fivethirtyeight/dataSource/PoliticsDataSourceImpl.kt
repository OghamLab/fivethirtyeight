...
class PoliticsDataSourceImpl @Inject constructor(private val apiService: ApiService) :
    PoliticsDataSource {


        override suspend  fun getPoliticsFeedList(): MutableList<FeedItem> {

            val listData = mutableListOf<FeedItem>()


            val responseResult = apiService.getFeedItems("abcnews/politicsheadlines")
       ...
       suspend fun getGoogleTop(): MutableList<FeedItem> {
     ...
     override  suspend fun getNyPolitics(): MutableList<FeedItem> {

            val listData = mutableListOf<FeedItem>()


            val responseResult =
                apiService.getFeedItems("https://rss.nytimes.com/services/xml/rss/nyt/Politics.xml")
    ...
    override suspend fun getNprPolitics(): MutableList<FeedItem> {

            val listData = mutableListOf<FeedItem>()


            val responseResult = apiService.getFeedItems("https://feeds.npr.org/1014/rss.xml")
