...
class TechDataSourceImpl @Inject constructor(private val apiService: ApiService) :
    TechDataSource {

        override suspend  fun getTechFeedList(): MutableList<FeedItem> {

            val listData = mutableListOf<FeedItem>()


            val responseResult = apiService.getFeedItems("abcnews/technologyheadlines")
       ...
       override suspend fun getGoogleTech(): MutableList<FeedItem> {

            val listData = mutableListOf<FeedItem>()


            val responseResult =
                apiService.getFeedItems("https://news.google.com/rss/topics/CAAqJggKIiBDQkFTRWdvSUwyMHZNRGRqTVhZU0FtVnVHZ0pWVXlnQVAB?hl=en-US&gl=US&ceid=US%3Aen")
     ...
     override  suspend fun getNyTech(): MutableList<FeedItem> {

            val listData = mutableListOf<FeedItem>()


            val responseResult =
                apiService.getFeedItems("https://rss.nytimes.com/services/xml/rss/nyt/Technology.xml")
...
*/
    ...
    override suspend fun getNprTech(): MutableList<FeedItem> {

            val listData = mutableListOf<FeedItem>()


            val responseResult = apiService.getFeedItems("https://feeds.npr.org//1019.xml")
