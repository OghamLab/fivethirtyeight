...
@Composable
fun WorldScreen( viewModel: SharedViewModel = hiltViewModel(),
                 onArticleClick: (FeedItem) -> Unit
) {

    val hasLoadedOnceWorld by viewModel.hasLoadedOnceWorld.collectAsStateWithLifecycle()
    val feedState by viewModel.worldFeedState.collectAsStateWithLifecycle()
    val isRefreshing by viewModel.isRefreshingWorld.collectAsState()
    ...
    PullToRefreshBox(
        ...
        onRefresh = { viewModel.fetchWorldStories(isUserRefresh = true) },
    ...
    /*Surface(modifier = Modifier.fillMaxSize()) {
        PullToRefreshBox(
            state = pullRefreshState,
            onRefresh = { viewModel.fetchWorldStories() },
            isRefreshing = isRefreshing,
            indicator = {
                PullToRefreshDefaults.Indicator(
                    state = pullRefreshState,
