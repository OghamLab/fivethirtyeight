...
@Composable
fun TechScreen(viewModel: SharedViewModel = hiltViewModel(),
                onArticleClick: (FeedItem) -> Unit
) {

    val hasLoadedOnceTech by viewModel.hasLoadedOnceTech.collectAsStateWithLifecycle()
    val feedState by viewModel.techFeedState.collectAsStateWithLifecycle()
    val isRefreshing by viewModel.isRefreshingTech.collectAsState()
    ...
    PullToRefreshBox(
        ...
        onRefresh = { viewModel.fetchTechStories(isUserRefresh = true) },
...
/*Surface(modifier = Modifier.fillMaxSize()) {
    PullToRefreshBox(
        state = pullRefreshState,
        onRefresh = { viewModel.fetchTechStories() },
        isRefreshing = isRefreshing,
        indicator = {
            PullToRefreshDefaults.Indicator(
                state = pullRefreshState,
