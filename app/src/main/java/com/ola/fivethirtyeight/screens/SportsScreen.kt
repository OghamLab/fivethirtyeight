...
@Composable
fun SportsScreen( viewModel: SharedViewModel = hiltViewModel(),
                  onArticleClick: (FeedItem) -> Unit
) {

    val hasLoadedOnceSports by viewModel.hasLoadedOnceSports.collectAsStateWithLifecycle()
    val context = LocalContext.current
    val feedState by viewModel.sportsFeedState.collectAsStateWithLifecycle()
    val isRefreshing by viewModel.isRefreshingSports.collectAsState()
    ...
    PullToRefreshBox(
        ...
        onRefresh = { viewModel.fetchSportsStories(isUserRefresh = true) },
...
/*Surface(modifier = Modifier.fillMaxSize()) {
    PullToRefreshBox(
        state = pullRefreshState,
        onRefresh = { viewModel.fetchSportsStories() },
        isRefreshing = isRefreshing,
        indicator = {
            PullToRefreshDefaults.Indicator(
                state = pullRefreshState,
