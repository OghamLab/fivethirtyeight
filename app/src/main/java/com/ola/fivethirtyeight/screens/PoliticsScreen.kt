...
fun PoliticsScreen(
    ...
    val hasLoadedOncePol by viewModel.hasLoadedOncePol.collectAsStateWithLifecycle()
    val context = LocalContext.current
    val feedState by viewModel.politicsFeedState.collectAsStateWithLifecycle()
    val isRefreshing by viewModel.isRefreshingPolitics.collectAsStateWithLifecycle()
    ...
    PullToRefreshBox(
        ...
        onRefresh = { viewModel.fetchPoliticsStories(isUserRefresh = true) },
